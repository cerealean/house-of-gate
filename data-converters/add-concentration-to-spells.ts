...
type SchoolsOfMagic = typeof schoolsOfMagic[number];

interface ISpell extends IStoredMetadata {
  id: string;
  name: string;
  level: number;
  ritual: boolean;
...
console.log(JSON.stringify(convertedSpells));
